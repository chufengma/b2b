...
public class SellerRequest extends AuthSession {
    ...
    public Seller generateSeller() {
        ...
        seller.allCer = sellerRequest.allCer == null ? "" : sellerRequest.allCer.getPath();
        seller.businessLic = sellerRequest.businessLic == null ? "" : sellerRequest.businessLic.getPath();
        seller.codeLic = sellerRequest.codeLic == null ? "" : sellerRequest.codeLic.getPath();
        seller.financeLic = sellerRequest.financeLic == null ? "" : sellerRequest.financeLic.getPath();
        return seller;
    }
}
